...
TOOL_NAME = "get_search_support_docs"
TOOL_DESCRIPTION = "Search support documents based on the user prompt and product name return relevant content."
TOOL_PARAMETERS = {
    "type": "object",
    "properties": {
        "question": {
            "type": "string",
            "description": "The question to ask about Access Handisoft, eg how do I download and update the latest version of Handisoft?",
        }
    },
    "required": ["question"],
}
    ...
    async def _call_copilot_skill(self, question: str) -> Any:
        ...
        try:
            ...
            payload = {
                ...
                "agentsToBeUsed": ["AccessHandisoftSkill"]
            }

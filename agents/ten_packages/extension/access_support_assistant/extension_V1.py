...
LIST_SECTIONS_DESCRIPTION = "Retrieves all available sections in the document by doc_name. This tool provides a list of all available sections in the document."

SEARCH_DOCS_TOOL_NAME = "search_volcanic_docs"
SEARCH_DOCS_DESCRIPTION = "Retrieves document content by doc_name,section_name. This tool provides the search result and content based on the parameters. If no result is found try tweaking the parameters to and call this tool again.Use the get_volcanic_docs tool to get the relevant document names. Use the list_volcanic_doc_sections tool to get the relevant section names."
